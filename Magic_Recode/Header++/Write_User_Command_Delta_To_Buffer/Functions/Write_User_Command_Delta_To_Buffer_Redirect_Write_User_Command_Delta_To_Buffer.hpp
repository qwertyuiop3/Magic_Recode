...
void Redirect_Write_User_Command_Delta_To_Buffer(void* Client_Module_Location)
{
	...
	Redirection_Manager::Redirect_Function(Original_Write_User_Command_Delta_To_Buffer_Caller_Location, 0, (void*)((unsigned __int32)Byte_Manager::Find_Bytes(sizeof Write_user_Command_Delta_To_Buffer_Bytes, Client_Module_Location, Write_user_Command_Delta_To_Buffer_Bytes, 0) - 10), Redirected_Write_User_Command_Delta_To_Buffer);
}