...
__int32 __stdcall DllMain(void* This_Module_Location, unsigned __int32 Call_Reason, void* Reserved)
{
	if (Call_Reason == DLL_PROCESS_ATTACH)
	{
		...
		IDirect3DDevice9* Direct_3_Dimensional_Device_9 = **(IDirect3DDevice9***)((unsigned __int32)Byte_Manager::Find_Bytes(GetModuleHandleW(L"shaderapidx9.dll"), Direct_3_Dimensional_Device_9_Bytes, sizeof(Direct_3_Dimensional_Device_9_Bytes)) - 16);
